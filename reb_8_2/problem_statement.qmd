...
Linearize the reactor model for this problem and show how to calculate the new variables in it. Then describe how to use the linearized model to assess the accuracy of the rate expression, equation (2).