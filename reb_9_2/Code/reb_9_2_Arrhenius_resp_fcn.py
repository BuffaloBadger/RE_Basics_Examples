...
df = pd.read_csv(filepath_to_results + 'reb_9_2_resp_fcn_params.csv')
...
result.to_csv(filepath_to_results + "reb_9_2_Arrhenius_resp_fcn.csv", \
    index=False)
...
plt.tight_layout()
filename = 'reb_9_2_Arrhenius_resp_fcn.png'
