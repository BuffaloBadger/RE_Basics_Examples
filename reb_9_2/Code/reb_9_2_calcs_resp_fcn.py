...
import reb_9_2_response_fcn as rf
import matplotlib.pyplot as plt

# set filepaths
filepath_to_data = './reb_9_2/Data/'
filepath_to_results = './reb_9_2/Results/'
...
df = pd.read_csv(filepath_to_data + 'reb_9_2_data_filenames.csv')
...
for filename in filenames:
    ...
    plt.tight_layout()
    name = 'reb_9_2_parity_' + T_as_text + '.png'
    ...
    plt.title('T = ' + T_as_text + ' °C')
    plt.tight_layout()
    name = 'reb_9_2_residual_PA0_' + T_as_text + '.png'
    plt.savefig(filepath_to_results  + name)
    plt.savefig(filepath_to_figures + name)
    plt.show()
    ...
    plt.title('T = ' + T_as_text + ' °C')
    plt.tight_layout()
    name = 'reb_9_2_residual_PB0_' + T_as_text + '.png'
    plt.savefig(filepath_to_results  + name)
    plt.savefig(filepath_to_figures + name)
    plt.show()
    ...
    plt.title('T = ' + T_as_text + ' °C')
    plt.tight_layout()
    name = 'reb_9_2_residual_t_rxn_' + T_as_text + '.png'
    plt.savefig(filepath_to_results  + name)
    plt.savefig(filepath_to_figures + name)
    plt.show()
...
print('\nThese results are being saved as ' + filepath_to_results + \
      'reb_9_2_resp_fcn_params.csv')
parameter_estimates.to_csv(filepath_to_results + 'reb_9_2_resp_fcn_params.csv',\
    index=False)