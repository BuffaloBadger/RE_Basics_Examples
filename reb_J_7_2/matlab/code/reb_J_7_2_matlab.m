function reb_J_7_2_matlab
%REB_J_7_2_MATLAB Reaction Engineering Basics Example J.7.2
    ...
    disp(['Final Molar Flow of A: ', num2str(nDot_A_f,3), ' mol/min'])
    disp(['Final Molar Flow of Z: ', num2str(nDot_Z_f,3), ' mol/min'])
end