...
# set filepaths
filepath_to_data = './reb_9_3/Data/'
filepath_to_results = './reb_9_3/Results/'
...
df = pd.read_csv(filepath_to_data + 'reb_9_3_data.csv')
        # columns: PA0, t, P
...
result.to_csv(filepath_to_results + '/reb_9_3_results.csv', index=False)
...
plt.savefig(filepath_to_figures + 'reb_9_3_parity.png')
plt.savefig(filepath_to_results + 'reb_9_3_parity.png')
plt.show()
...
plt.savefig(filepath_to_figures + 'reb_9_3_PA0_residuals.png')
plt.savefig(filepath_to_results + 'reb_9_3_PA0_residuals.png')
plt.show()
...
plt.ylabel("Residual (atm)")
plt.savefig(filepath_to_figures + 'reb_9_3_t_residuals.png')
plt.savefig(filepath_to_results + 'reb_9_3_t_residuals.png')
plt.show()