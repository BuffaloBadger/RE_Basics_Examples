...
# set filepaths
filepath_to_data = './reb_19_4/Data/'
filepath_to_results = './reb_19_4/Results/'
...
df = pd.read_csv("reb_19_4/Data/reb_19_4_data.csv")
        # columns CS0, t, CP
...
result.to_csv(filepath_to_results + "reb_19_4_results.csv", index=False)
...
plt.savefig(filepath_to_results + 'reb_19_4_parity.png')
plt.savefig(filepath_to_figures + 'reb_19_4_parity.png')
plt.show()
...
plt.savefig(filepath_to_results + 'reb_19_4_residuals_vs_t.png')
plt.savefig(filepath_to_figures + 'reb_19_4_residuals_vs_t.png')
plt.show()
...
plt.savefig(filepath_to_results + 'reb_19_4_residuals_vs_CS0.png')
plt.savefig(filepath_to_figures + 'reb_19_4_residuals_vs_CS0.png')
plt.show()