...
import two_par_response_function as rf
...
result.to_csv(filepath1 + "reb_10_3_two_par_results.csv", index=False)

# calculate the model-predicted responses
y_model = rf.response_function(adjusted_inputs,beta[0],beta[1])
...
filename = filepath1 + 'reb_10_3_2_par_parity.png'
plt.savefig(filename)
filename = filepath2 + 'reb_10_3_2_par_parity.png'
plt.savefig(filename)
plt.show()
...
filename = filepath1 + 'reb_10_3_2_par_residuals_vs_yAin.png'
plt.savefig(filename)
filename = filepath2 + 'reb_10_3_2_par_residuals_vs_yAin.png'
plt.savefig(filename)
plt.show()
...
# save and show the residuals plot for the reaction time
filename = filepath1 + 'reb_10_3_2_par_residuals_vs_yBin.png'
plt.savefig(filename)
filename = filepath2 + 'reb_10_3_2_par_residuals_vs_yBin.png'
plt.savefig(filename)
plt.show()
...
# save and show the residuals plot for the reaction time
filename = filepath1 + 'reb_10_3_2_par_residuals_vs_yYin.png'
plt.savefig(filename)
filename = filepath2 + 'reb_10_3_2_par_residuals_vs_yYin.png'
plt.savefig(filename)
plt.show()
...
# save and show the residuals plot for the reaction time
filename = filepath1 + 'reb_10_3_2_par_residuals_vs_yZin.png'
plt.savefig(filename)
filename = filepath2 + 'reb_10_3_2_par_residuals_vs_yZin.png'
plt.savefig(filename)
plt.show()