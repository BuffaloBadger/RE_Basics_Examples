...
df = pd.read_csv('reb_19_5_1/python/reb_19_5_1_data.csv')
...
for T_K in block_temperatures:
    ...
    filename = 'reb_19_5_1_data_' + T_as_text + '.csv'
    block.to_csv('reb_19_5_1/python/' + filename,index=False)

    # save the filename
    filenames.loc[len(filenames.index)] = [filename]

# save the data file filenames
filenames.to_csv('reb_19_5_1/python/reb_19_5_1_data_filenames.csv',index=False)