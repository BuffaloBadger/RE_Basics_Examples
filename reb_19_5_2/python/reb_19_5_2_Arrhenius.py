...
df = pd.read_csv('reb_19_5_2/python/reb_19_5_2_resp_fcn_params.csv')
...
result.to_csv("reb_19_5_2/python/reb_19_5_2_Arrhenius_resp_fcn.csv", 
              index=False)
...
plt.tight_layout()
plt.savefig('reb_19_5_2/python/reb_19_5_2_Arrhenius_resp_fcn.png')
plt.show()

# read rate coefficients from linear model analysis
df = pd.read_csv('reb_19_5_2/python/reb_19_5_2_lin_params.csv')
    # columns: 'T', 'k', 'k_ll', 'k_ul', 'R_sq'
T = df['T'].to_numpy() + 273.15
k = df['k'].to_numpy()
...
data = [['k0', f'{k0:.3g}', 'min^-1^'],
    ...
    ['R_squared', f'{r_squared:.3g}', '']]
result = pd.DataFrame(data, columns=['item','value','units'])
result.to_csv("reb_19_5_2/python/reb_19_5_2_Arrhenius_lin.csv", 
              index=False)
...
plt.xticks(rotation=25)
plt.tight_layout()
plt.savefig('reb_19_5_2/python/reb_19_5_2_Arrhenius_lin.png')
plt.show()