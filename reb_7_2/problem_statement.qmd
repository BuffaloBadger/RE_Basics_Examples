...
Generate a reactor response function that could be used to find the reaction time maximizes the yield (mol D/initial mol A), and the yield and the conversion of A at that reaction time.