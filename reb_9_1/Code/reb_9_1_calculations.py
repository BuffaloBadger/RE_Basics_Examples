...
df = pd.read_csv('./reb_9_1/Data/reb_9_1_data.csv')
...
phase_1_results_df.to_csv('./reb_9_1/Results/reb_9_1_phase_1_results.csv',\
    index=False)
...
result.to_csv("./reb_9_1/Results/reb_9_1_Arrhenius_results.csv", index=False)
