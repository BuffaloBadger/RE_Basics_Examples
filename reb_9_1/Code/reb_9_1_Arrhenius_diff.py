...
df = pd.read_csv(filepath_to_results + 'reb_9_1_diff_params.csv')
...
result.to_csv(filepath_to_results + "reb_9_1_Arrhenius_diff.csv", \
    index=False)
...
plt.tight_layout()
filename = 'reb_9_1_Arrhenius_diff.png'
