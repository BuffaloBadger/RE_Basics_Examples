...
df = pd.read_csv(filepath_to_data + 'reb_9_1_data.csv')
...
for T_K in block_temperatures:
    ...
    filename = 'reb_9_1_data_' + T_as_text + '.csv'
...
filenames.to_csv(filepath_to_data + 'reb_9_1_data_filenames.csv',index=False)