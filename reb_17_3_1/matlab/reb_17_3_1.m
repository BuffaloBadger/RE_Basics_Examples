function reb_17_3_1
    ...
    function derivs = derivatives(~, dep)
        ...
        dTdz = -pi()*D^2/4*r_1*dH_1/Vdot_PFR/Cp;
    ...
    function resid = residuals(guess)
        ...
        [~, nDotA_PFR, nDotZ_PFR, T_PFR] = profiles(initial_values);

        % extract final values
        nDotA_2 = nDotA_PFR(end);
        nDotZ_2 = nDotZ_PFR(end);
        T_4 = T_PFR(end);
	...
	function perform_the_analysis()
        ...
        [~, nDotA_PFR, nDotZ_PFR, T_PFR] = profiles(dep_0);
        ...
        % calculate the product concentrations (in mol /L)
        Vdot_3 = Vdot_0;
