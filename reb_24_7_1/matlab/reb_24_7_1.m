function reb_24_7_1()
% Calculations for Reaction Engineering Basics Example 24.7.1
    ...
    function perform_the_calculations()
        ...
        % solve the axial dispersion equations
        g_Dax = 1.0E0;
        g_lambda = 1.0E6;
        ...
        set(ft,'PaperPositionMode','Auto','PaperUnits','Inches'...
            ,'PaperSize',[pos(3), pos(4)])
        print(ft,'T_profile.pdf','-dpdf','-r0')
    end
