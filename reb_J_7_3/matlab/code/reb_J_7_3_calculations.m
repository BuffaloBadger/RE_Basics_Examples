function reb_J_7_3_calculations
%REB_J_7_3_CALCULATIONS Reaction Engineering Basics Example J.7.3

    % results file specification
    Tin_results_file_spec = '../results/reb_J_7_3_Tin_result.csv';
    profile_results_file_spec = '../results/reb_J_7_3_profile_results.csv';
    ...
    % save the results
    writetable(Tin_results_table,Tin_results_file_spec);
    writetable(profile_results_table,profile_results_file_spec);
end