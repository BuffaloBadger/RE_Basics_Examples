...
df = pd.read_csv(filepath_to_results + 'reb_19_2_lin_params.csv')
...
result.to_csv(filepath_to_results + "reb_19_2_Arrhenius_lin.csv", \
    index=False)
...
plt.tight_layout()
filename = 'reb_19_2_Arrhenius_lin.png'
