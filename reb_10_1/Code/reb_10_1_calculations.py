...
result.to_csv(filepath1 + "reb_10_1_results.csv", index=False)
...
filename = filepath1 + 'reb_10_1_parity.png'
plt.savefig(filename)
filename = filepath2 + 'reb_10_1_parity.png'
plt.savefig(filename)
plt.show()
...
filename = filepath1 + 'reb_10_1_residuals_vs_VFR_A.png'
plt.savefig(filename)
filename = filepath2 + 'reb_10_1_residuals_vs_VFR_A.png'
plt.savefig(filename)
plt.show()
...
# save and show the residuals plot for the reaction time
filename = filepath1 + 'reb_10_1_residuals_vs_VFR_Y.png'
plt.savefig(filename)
filename = filepath2 + 'reb_10_1_residuals_vs_VFR_Y.png'
plt.savefig(filename)
plt.show()
...
# save and show the residuals plot for the reaction time
filename = filepath1 + 'reb_10_1_residuals_vs_VFR_Z.png'
plt.savefig(filename)
filename = filepath2 + 'reb_10_1_residuals_vs_VFR_Z.png'
plt.savefig(filename)
plt.show()