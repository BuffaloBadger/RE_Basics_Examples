...
**Adjusted Inputs**: $\underline{\dot{V}_{A,in}}$, $\underline{\dot{V}_{Y,in}}$, and $\underline{\dot{V}_{Z,in}}$.
...
$$
\dot{n}_A\Big\vert_{z=0} = \dot{n}_{A,in} = \frac{P\dot{V}_{A,in}}{RT} \tag{7}
$$

$$
\dot{n}_Y\Big\vert_{z=0} = \dot{n}_{Y,in} = \frac{P\dot{V}_{Y,in}}{RT} \tag{8}
$$

$$
\dot{n}_Z\Big\vert_{z=0} = \dot{n}_{Z,in} = \frac{P\dot{V}_{Z,in}}{RT} \tag{9}
$$
