...
import reb_19_1_response_function as rf
...
for filename in filenames:
    ...
    plt.tight_layout()
    name = 'reb_19_1_resp_fcn_parity_' + T_as_text + '.png'
    ...
    plt.title('T = ' + T_as_text + ' °C')
    plt.tight_layout()
    name = 'reb_19_1_resp_fcn_residual_CA0_' + T_as_text + '.png'
    plt.savefig(filepath_to_results  + name)
    plt.savefig(filepath_to_figures + name)
    plt.show()
    ...
    plt.title('T = ' + T_as_text + ' °C')
    plt.tight_layout()
    name = 'reb_19_1_resp_fcn_residual_t_rxn_' + T_as_text + '.png'
    plt.savefig(filepath_to_results  + name)
    plt.savefig(filepath_to_figures + name)
    plt.show()
...
print('\nThese results are being saved as ' + filepath_to_results + \
      'reb_19_1_resp_fcn_params.csv')
parameter_estimates.to_csv(filepath_to_results + 'reb_19_1_resp_fcn_params.csv',\
    index=False)
